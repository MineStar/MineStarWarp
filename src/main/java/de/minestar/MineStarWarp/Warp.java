...
public class Warp {
    ...
    public boolean canUse(Player player) {
        return isPublic() || canEdit(player) || UtilPermissions.playerCanUseCommand(player, "minestarwarp.useAll") || guests.contains(player.getName().toLowerCase());
    ...
    public boolean canEdit(Player player) {
        return isOwner(player.getName()) || player.isOp() || UtilPermissions.playerCanUseCommand(player, "minestarwarp.editAll");
    }
